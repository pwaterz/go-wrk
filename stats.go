...
func PrintStats(allStats *Stats) {
	...
	fmt.Printf("85th percentile time:\t\t%.2fms\n", float64(allStats.Times[(totalInt/100*85)])/1000)
	fmt.Printf("90th percentile time:\t\t%.2fms\n", float64(allStats.Times[(totalInt/100*90)])/1000)
	fmt.Printf("95th percentile time:\t\t%.2fms\n", float64(allStats.Times[(totalInt/100*95)])/1000)
